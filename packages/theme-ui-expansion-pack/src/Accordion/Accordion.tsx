...
function getExpandCondition(index: number | Array<number>, itemIndex: number) {
...
export const Accordion = forwardRef<HTMLDivElement, IAccordionProps>(function(
  { allowMultiple, allowToggle, index, defaultIndex, onChange, children, ...rest },
  ref,
) {
